...
async def _ensure_indexes():
    ...
    try:
        # Users collection
        # sparse=True on user_id so pre-existing null documents don't cause
        # E11000 duplicate key errors while still enforcing uniqueness for
        # real user_ids.
        ...
        # Rate limiting collection — TTL index auto-deletes old records
